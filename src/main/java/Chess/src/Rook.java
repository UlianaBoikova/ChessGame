...
/**
 The ChessPiece class should change the position of a rook and return a list of positions available for movement.
 */
public class Rook extends ChessPiece {
     ...
     */
    public Rook(ChessField chessField, String position, String color, String picture) {
